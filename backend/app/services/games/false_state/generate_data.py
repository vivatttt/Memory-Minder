...
class YandexGPTStupidResponse(Exception):
    pass
...
class GenerateData:
    ...
    def get_game_data(self, difficulty: int, wrong_states: int = 4, correct_states: int = 8):
        text = self._get_text(
            prompts=[
                ("Придумай тематику для текста, сложность которой для прочтения будет {difficulty}/10. В ответ напиши только название темы"), 
